...
const CodeConverter: React.FC = () => {
  const [python2Code, setPython2Code] = useState(`# Python 2 Legacy Code
import urllib2
import ConfigParser
...
def get_user_data(user_id):
    ...
    url = config.get('api', 'base_url') + '/users/' + str(user_id)
...
print user_data`);
  ...
  const [python3Code, setPython3Code] = useState(`# Python 3 Converted Code
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[calc(100vh-200px)]">
          ...
          <div className="bg-white rounded-lg shadow-sm border flex flex-col">
            ...
            <div className="flex-1 relative">
              ...
              />
              <button className="absolute top-2 right-2 p-2 bg-gray-800 hover:bg-gray-700 rounded text-white">
                <Copy size={14} />
              </button>
            </div>
          </div>
        ...
        <div className="mt-6 bg-white p-4 rounded-lg shadow-sm border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <span className="ml-2 font-medium">7 modifications</span>
            </div>
            <div>
              <span className="text-gray-600">Time Taken:</span>
              <span className="ml-2 font-medium">1.2 seconds</span>
            </div>
            <div>
